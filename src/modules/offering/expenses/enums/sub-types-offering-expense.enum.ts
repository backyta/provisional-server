...
export const SubTypesOfferingExpenseNames: Record<
...
> = {
  ...
  heating_and_ac_system_maintenance:
    'Mantenimiento de sistemas de calefacción y AC',
  sound_and_lighting_equipment_repair_and_maintenance:
  ...
  computer_equipment_repair_and_maintenance:
  ...
  altar_and_worship_area_decoration_service:
    'Servicio de decoración de altar y areas de culto',
  ...
  internet_and_telecommunications_services:
  ...
  rental_technical_and_logistical_equipment:
