...
> = {
  ...
  [OfferingIncomeCreationCategory.ActivitiesProChurchGround]:
    'Actividades Pro-Terreno',
  [OfferingIncomeCreationCategory.Events]:
    'Eventos (campañas, dedicaciones, etc.)',
  [OfferingIncomeCreationCategory.FundraisingProMinistry]:
    'Actividades Pro-Ministerio',
  [OfferingIncomeCreationCategory.Meetings]:
    'Reuniones (enseñanzas, conferencias, etc.)',
};
