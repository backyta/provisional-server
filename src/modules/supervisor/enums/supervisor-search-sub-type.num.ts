...
export const SupervisorSearchSubTypeNames: Record<
  SupervisorSearchSubType,
  string
> = {
  [SupervisorSearchSubType.SupervisorByPastorNames]: 'Por nombres de su pastor',
  [SupervisorSearchSubType.SupervisorByPastorLastNames]:
    'Por apellidos de su pastor',
  [SupervisorSearchSubType.SupervisorByPastorFullName]:
    'Por nombres y apellidos de su pastor',
  [SupervisorSearchSubType.SupervisorByCopastorNames]:
    'Por nombres de su co-pastor',
  [SupervisorSearchSubType.SupervisorByCopastorLastNames]:
    'Por apellidos de su co-pastor',
  [SupervisorSearchSubType.SupervisorByCopastorFullName]:
